...
public class RoleController {
    ...
    @DeleteMapping("admin/user/{userId}/role/{name}")
    public ResponseEntity<HttpStatus> deleteRole(@PathVariable Long userId, @PathVariable String name){
        roleService.deleteRoleFromUser(name, userId);
